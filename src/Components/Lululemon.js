...
class Lululemon extends React.Component {
   render() {
      return (
        <div className="route-section fade-enter-done">
         <div className="ebay">
           <div className="innerWrapper">
             ...
             <div className="section">
               <div className="sectionContent">
                 <h2>Overview</h2>
                 <p>
                   Last Summer I worked as a <b>UX Design Intern</b> for Lululemon <b>Design Systems</b> team. Traditionally Lululemon has not had a cohesive
                 ...
                 <p>
                   I spent a little over a week combing through both of Lululemon mobile
